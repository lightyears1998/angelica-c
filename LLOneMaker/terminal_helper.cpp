...
namespace angelica
{
	...
	{
		// 设置单词符号在控制台输出时的颜色
		colorsheet_[SymbolType::TERMINAL] = TerminalColor::BRIGHT_BLUE;
		colorsheet_[SymbolType::STRUCTURE] = TerminalColor::BRIGHT_RED;
		colorsheet_[SymbolType::NONTERMINAL] = TerminalColor::BRIGHT_YELLOW;
	}
